...
<head>
  ...
  <title>BAKNUS REVARASI</title>
  <link rel="icon" href="../assets/dist/img/YPDM_BAKNUS.png">
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/YPDM_BAKNUS.png" alt="BAKNUS REVARASI" class="brand-image " style="opacity: .8">
      <span class="brand-text font-weight-bold" style="font-size: 20px;">BAKNUS REVARASI</span>
    </a>
