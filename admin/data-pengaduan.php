...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card mb-auto">
      <div class="card-header">
        <h3 class="card-title"><i class="fas fa-ban mr-3"></i>Dibatalkan</h3>
        <div class="card-tools">
          <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
            <i class="fas fa-minus"></i>
          </button>
      ...
      <div class="card-body">
        <div class="table">
          <table class="table-hover" id="table4" width="100%">
            <thead align="center">
              <th>No.</th>
              <th>Nama Pelapor</th>
              <th>Nama Barang</th>
            ...
            <tbody align="center">
              <?php
              $data = query("SELECT * FROM pengaduan WHERE status='Dibatalkan'");
              foreach ($data as $d) :
              ?>
              <tr>
                <td><?= $d['id']; ?></td>
