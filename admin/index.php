              ...
              <tbody>
                ...
                ?>
                  <tr align="center">
                    ...
                    <td><div style="width: 100px; height: 100px; overflow: hidden; display: flex; align-items: center; justify-content: center; border-radius: 4px; border: 1px solid #ddd;">
    			<img src="../assets/img/profile/<?= $d['img']; ?>" alt="user image" style="width: 100%; height: 100%; object-fit: cover;">
  			</div>
			</td>
