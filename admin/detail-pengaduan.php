        ...
        <div class="card-body">
          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="row">
                <div class="col-md-4">
                  <label for="dp">Ruang/Kelas :</label>
              ...
              <div class="row">
                <div class="col-md-4" style="border: 1px solid #ced4da; border-radius: 5px; margin: 7px 7px; padding: 7px 10px;">
                  ...
                  <?php
                    ...
                    $statuses[$d['status']] = 'checked';
                  ?>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="Sedang diajukan" id="opt1" name="status" class="custom-control-input" <?= $statuses['Sedang diajukan']; ?>>
                    <label class="custom-control-label" for="opt1">Sedang diajukan</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="Sedang diproses" id="opt2" name="status" class="custom-control-input" <?= $statuses['Sedang diproses']; ?>>
                    <label class="custom-control-label" for="opt2">Sedang diproses</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="Selesai diproses" id="opt3" name="status" class="custom-control-input" <?= $statuses['Selesai diproses']; ?>>
                    <label class="custom-control-label" for="opt3">Selesai diproses</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="Dibatalkan" id="opt4" name="status" class="custom-control-input" <?= $statuses['Dibatalkan']; ?>>
                    <label class="custom-control-label" for="opt4">Dibatalkan</label>
                  </div>
                </div>
              </div>
              <div class="row">
