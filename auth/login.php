...
<head>
    ...
    <title>Login | BAKNUS REVARASI</title>
    <!-- icon diskominfo -->
...
<body>
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6">
                <a class="btn logo" href="../index.php">BAKNUS REVARASI</a>
                <img src="css/YPDM_BAKNUS.png" width="40" height="40">
                <p class="lead">YPDM Bakti Nusantara 666</p>
