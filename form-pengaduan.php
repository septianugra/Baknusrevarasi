...
// angka yang diambil tadi digabungkan dengan kode huruf yang kita inginkan, misalnya BN 
$huruf = "NP";
      ...
      <form action="" method="POST">
        <div class="form-row p-3">
          <div class="form-group">
              <label for="id" style="font-weight: bold;">Nomor Pengaduan</label>
          ...
          <div>
          <div class="form-group"> 
              <label for="nama" style="font-weight: bold;">Nama Pelapor</label > 
              <input type="text" name="nama" id="nama" class="form-control"  required placeholder="Contoh : Septian Nugraha">
          <div>
          <div class="form-group">
              <label for="jabatan" style="font-weight: bold;">Jurusan</label>
              <input type="text" name="jabatan" id="jabatan" class="form-control" required placeholder="Contoh : Pengembangan Perangkat Lunak dan Gim atau PPLG">
          <div>
          <div class="form-group">
              <label for="dept" style="font-weight: bold;">Ruang Lab / Kelas</label>
              <input type="text" name="dept" id="dept" class="form-control" required placeholder="Contoh : Lab 3d / Lab Pk Lantai 1 / Studio Photo">
          <div>
          <div class="form-group">
              <label for="nama_barang" style="font-weight: bold;">Nama Barang</label>
              <input type="text" name="nama_barang" id="nama_barang" class="form-control" required placeholder="Contoh : Mouse / Keyboard / Monitor">
          <div>
          <div class="form-group">
